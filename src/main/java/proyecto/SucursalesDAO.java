...
public class SucursalesDAO {
    ...
    public void modificar(int cod, String nom, String dir, String correo, int tel){
        String sql = "update sucursales set Nombre='"+nom+"', Direccion='"+dir+"', Correo='"+correo+"', Telefono='"+tel+"' where Codigo='"+cod+"'";
        try{
            con = conectar.Conectar();
            ps = con.prepareStatement(sql);
            ps.executeUpdate();
    ...
    public void eliminar(int cod){
        String sql = "delete from sucursales where codigo= " + cod;
        try{
            con = conectar.Conectar();
            ps = con.prepareStatement(sql);
            ps.executeUpdate();
